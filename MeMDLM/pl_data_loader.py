...
#     def train_dataloader(self):
#         return DataLoader(self.train_dataset, collate_fn=self.collate_fn, num_workers=4, pin_memory=True)

#     def val_dataloader(self):
#         return DataLoader(self.val_dataset, collate_fn=self.collate_fn, num_workers=4, pin_memory=True)
  
#     def test_dataloader(self):
#         return DataLoader(self.test_dataset, collate_fn=self.collate_fn, num_workers=4, pin_memory=True)
